...
- **StencilRefDto** added to NodeDto in template model — nodes can carry a stencil reference (stencilId + version) to track embedded stencil origin and enable upgrade detection
