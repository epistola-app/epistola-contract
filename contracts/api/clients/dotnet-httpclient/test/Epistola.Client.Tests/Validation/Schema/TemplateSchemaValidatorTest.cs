...
public class TemplateSchemaValidatorTest
{
    ...
    private static ITemplatesApi ApiReturningSchema(object? schema)
    {
        ...
        api.GetTemplate("acme", "default", "person").Returns(new TemplateDto(key: "person", id: "person", tenantId: "acme", name: "Person", schema: schema, variants: new List<VariantSummaryDto>()));
        return api;
    }
